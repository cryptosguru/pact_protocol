...
(module stablecoin-example GOVERNANCE

  @doc " 'stablecoin-example' represents a hypothetical stablecoin \
       \ implementing the fungible-v1 token interface. A stablecoin should be \
       \ used for all payments occurring in the Finprint smart contract. \
       \ \
       \ Copied from finprint-token.pact which is itself adapted from Kadena's \
       \ coin.pact contract. "
